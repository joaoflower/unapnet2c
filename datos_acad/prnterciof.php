	...
	if(fsafetyselcar2())
	{
		class PDF extends FPDF
		{
			...
			function Subcuadro()
			{
				...
				$this->Cell(140,4,"TERCIO SUPERIOR [{$sUsercoo['ano_aca']}]", 0, 0, 0,'R');
				$this->SetFont('arialn','B',10);
				$this->Ln();
...
//				$this->Ln();
				...
				//$this->Cell(10);
				$this->Cell(140,4, "TERCIO SUPERIOR EMITIDO SEGÚN: RESOLUCIÓN RECTORAL N° 1682-2006-R-UNA", 0, 0, 0,'R');				
				$this->Ln();		
				
				//$this->Cell(10);
				$this->Cell(140,4, "ALCANCE: Art. 06 Para el cálculo del tercio superior solo se considera a la tercera parte de los estudiantes que aprobaron más de 24 créditos consignados en el Cuadro de Méritos", 0);				
				$this->Ln();				
