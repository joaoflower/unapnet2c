...
<table border="1" cellpadding="1" cellspacing="0" bordercolor="#BDD37B" rules="cols, rows" class="tabled">
  ...
  <tr <? if($vCont % 2 == 0) echo "class=\"celpar\" id=\"p\""; else echo "class=\"celinpar\" id=\"i\"";?> onMouseOver="mouseover(this)" onMouseOut="mouseout(this)">
    ...
    <td width="58"><a href="" onClick="getcargacurso('<?=$aEstudia['cod_prf']?>'); return false;" class="enlace1">
      <?=$aEstudia['cod_prf']?>
    </a></td>
    ...
    <td width="16" class="wordizq"><a href="" onClick="getcargacurso('<?=$aEstudia['cod_prf']?>', '<?=$sUsercoo['pln_est']?>', '<?=$sUsercoo['sec_gru']?>', '<?=$sUsercoo['mod_mat']?>'); return false;" class="enlaceb"><img src="../images/browse.png" alt="Mostrar informaci&oacute;n" width="16" height="16" /></a></td>
  </tr>
  	<? 
		$vCont++; 	
		} 
