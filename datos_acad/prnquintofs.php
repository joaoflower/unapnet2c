	...
	if(fsafetyselcar2())
	{
		class PDF extends FPDF
		{
			...
			function Subcuadro()
			{
				...
				$this->Cell(140,4,"QUINTO SUPERIOR [{$sUsercoo['ano_aca']}-{$sPeriodo[$sUsercoo['per_aca']]['abr_per']}]", 0, 0, 0,'R');
				$this->SetFont('arialn','B',10);
				$this->Ln();
...
//				$this->Ln();
				...
				//$this->Cell(10);
				$this->Cell(140,4, "QUINTO SUPERIOR EMITIDO SEGÚN: REGLAMENTO APROBADO EN C.U. DEL 04 y 06 DIC 2006 ", 0, 0, 0,'R');				
				$this->Ln();		
				
				//$this->Cell(10);
				$this->Cell(140,4, "ALCANCE: Art. 10: El tercio superior lo constituirán la tercera parte de los estudiantes del ranking semestral y promocional de cada Escuela Profesional", 0);				
				$this->Ln();				
