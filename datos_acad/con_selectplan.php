        ...
        <tr>
          ...
          <td background="../images/ventana_r2_c2.jpg" class="wordcen"><table border="0" cellpadding="1" cellspacing="0" bordercolor="#BDD37B" rules="cols, rows" class="tabled">            
			<tr>
              ...
              <td width="300" class="wordizq"><select name="rPln_est" id="rPln_est" onChange="getespcon(this.value)" onFocus="getespcon(this.value)">
			  	<?=fviewplan($sEstudia['pln_est'])?>
                </select></td>
            </tr>
			<tr>
			  <td class="wordder">Especialidad: </td>
			  <td class="wordizq"  id="xEspecial"><select name="rPln_est" id="rPln_est" onChange="getnotacon(this.value)" onFocus="getnotacon(this.value)" disabled="disabled">
