...
//	$vQuery = "Select distinct pln_est from $tEstumat where (per_aca = '01' or per_aca = '02') order by pln_est";
	...
	$vQuery .= "where (em.per_aca = '01' or em.per_aca = '02') and pl.tip_sist = '2' order by pln_est";
	$cPlan = fQuery($vQuery);	
	while($aPlan = $cPlan->fetch_array())
	{
		...
		if(!empty($vCrd_ini) and !empty($vCrd_fin))		
		{
			...
			$vQuery .= "no.num_mat in (select distinct num_mat from $tEstumat where (per_aca = '01' or per_aca = '02') and pln_est = '{$aPlan['pln_est']}') ";
	...
	foreach($sEstucdo as $vNum_mat => $aEstucdo)
	{
		...
		$vQuery .= "no.mod_not = '11' or no.mod_not = '14' or no.mod_not = '15' or no.mod_not = '16' or no.mod_not = '17' or ";
		$vQuery .= "no.mod_not = '18' or no.mod_not = '19'  or no.mod_not = '12'  or no.mod_not = '13'  ) group by per_aca";
		$cNota = fQuery($vQuery);
  ...
  ?>
	...
	<table border="0" cellpadding="0" cellspacing="0" id="ventana">
	  ...
	  <a href="prncuadrof.php" title="Imprimir" class="linkboton" target="frPdf"><img src="../images/bprint.png" width="100" height="24" /></a>
	  <a href="prnterciof.php" title="Imprimir" class="linkboton" target="frPdf"><img src="../images/btercio.png" width="100" height="24" /></a>
	  <a href="prnquintof.php" title="Imprimir" class="linkboton" target="frPdf"><img src="../images/bquinto.png" width="100" height="24" /></a>	  
