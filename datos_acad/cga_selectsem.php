...
<!--
	...
	function del_carga(pln_est, cod_cur, sec_gru, mod_mat, cod_prf)
	{
		var vReturn;
		var vAtributo;
		...
		if(vReturn == '1')
		{
			window.location.href = "cga_delcarga.php";
		}
	}
//-->
</script>
...
<div class="wordcen" id="body1">
	<a href="cga_getcarga.php" title="Nueva Notas" class="linkboton" ><img src="../images/bnuevocar.png" width="100" height="24"></a>
	 ...
	 <?
	  ...
	  ?>
        ...
        <tr>
          ...
          <th align="center" background="../images/ventana_r1_c2.jpg" >Carga Acad&eacute;mica  del Plan: <?=$vPlnesp." - ".$sTiposist[$sPlan[$vPlnesp]]?></th>
        ...
        <tr>
		 ...
		 <table border="1" cellpadding="1" cellspacing="0" bordercolor="#BDD37B" rules="cols, rows" class="tabled">
            ...
            <tr <? if($vCont % 2 == 0) echo "class=\"celpar\""; else echo "class=\"celinpar\"";?>>
              ...
              <td class="wordcen"><a href="" onclick="del_carga('<?=$aCurso['pln_est']?>', '<?=$aCurso['cod_cur']?>', '<?=$aCurso['sec_gru']?>', '<?=$aCurso['mod_mat']?>', '<?=$aCurso['cod_prf']?>'); return false;" class="enlaceb"><img src="../images/drop.png" alt="Eliminar" width="16" height="16" /></a></td>
            </tr>
			<?	$vCont++;	}	?>
          </table>
  ...
  <a href="cga_getcarga.php" title="Nueva Notas" class="linkboton" ><img src="../images/bnuevocar.png" width="100" height="24"></a>  </div>
