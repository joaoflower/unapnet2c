	...
	if(fsafetyselcar2())
	{
		class PDF extends FPDF
		{
			...
			function Subcuadro()
			{
				...
				$this->Cell(140,4,"CUADRO DE MÉRITOS [{$sUsercoo['ano_aca']}-{$sPeriodo[$sUsercoo['per_aca']]['abr_per']}]", 0, 0, 0,'R');
				$this->SetFont('arialn','B',10);
				$this->Ln();
...
//				$this->Ln();
				...
				//$this->Cell(10);
				$this->Cell(140,4, "CUADRO DE MÉRITOS EMITIDO SEGÚN: REGLAMENTO APROBADO EN C.U. DEL 04 y 06 DIC 2006", 0, 0, 0,'R');				
				$this->Ln();		
				
				//$this->Cell(10);
				$this->Cell(140,4, "ALCANCE: LAS NOTAS DE REEVALUACIÓN NO SON CONSIDERADAS PARA ELABORAR EL CUADRO DE MÉRITOS", 0);				
				$this->Ln();				
