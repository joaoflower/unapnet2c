...
/*				$vQuery = "Select sem_anu, crd_sem, crd_ini, crd_fin from unapnet.credisem ";
	  ...
	  <!--<a href="" onclick="gen_cuadro(); return false;" title="Generar Cuadro de Méritos" class="linkboton"><img src="../images/bgencuaanu.png" width="100" height="24"></a>   -->
	  <a href="" onclick="gen_cuadrosem(); return false;" title="Generar Cuadro de Méritos" class="linkboton"><img src="../images/bgencuasem.png" width="100" height="24"></a>
	</form>
	</div>
