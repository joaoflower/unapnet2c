<?php
	...
	if(fsafetyselcar())
	{
		...
		$sPlnesp = "";
		$aNotacta = "";
		$sUsercoo['acta'] = "ACTAS EMITIDAS SIN NOTA";
		...
		$vQuery = "select distinct cod_act from $tNota where cod_car = '{$sUsercoo['cod_car']}' and ";
		$vQuery .= "ano_aca = '{$sUsercoo['ano_aca']}' and per_aca = '{$sUsercoo['per_aca']}' ";
		$cNotac = fQuery($vQuery);
		while($aNotac = $cNotac->fetch_array())
		{
			$aNotacta[$aNotac['cod_act']] = TRUE;
		}	
...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="0" id="ventana">
        <tr>
          ...
          <th align="center" background="../images/ventana_r1_c2.jpg" >Actas emitidas sin Nota del Plan : <?=$vPlnesp?> - <?=$sTiposist[$sPlan[$vPlnesp]]?></th>
