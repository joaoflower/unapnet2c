<?php
	...
	if(fsafetyselcar2())
	{
		$sUsercoo['cur_pre'] = $_GET['rCur_pre'];
		$vQuery = "Select nom_cur from unapnet.curso where cod_cur = '{$sUsercoo['cur_pre']}' and ";
...
<form action="" method="get" name="fData" id="fData">
  ...
  <div align="center" class="word12b">
		¿Estás seguro de que deseas ELIMINAR el  Pre-requisito: <br> 
		<?=$sUsercoo['nom_cur']?> ?		
		<br><br>
  </div>
	<div align="center">
