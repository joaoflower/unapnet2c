        ...
        <tr>
		 ...
		 <table border="1" cellpadding="1" cellspacing="0" bordercolor="#BDD37B" rules="cols, rows" class="tabled">
            ...
            <tr <? if($vCont % 2 == 0) echo "class=\"celpar\" id=\"p\""; else echo "class=\"celinpar\"  id=\"i\""; $vCont++;?>  onmouseover="mouseover(this)" onmouseout="mouseout(this)"> 
              <td class="wordcenb"><a href="act_actaemitida.php" class="enlace1" title="Actas Emitidas">ACTAS EMITIDAS</a></td>
            </tr>
            <tr <? if($vCont % 2 == 0) echo "class=\"celpar\" id=\"p\""; else echo "class=\"celinpar\"  id=\"i\""; $vCont++;?>  onmouseover="mouseover(this)" onmouseout="mouseout(this)">
              <td class="wordcenb"><a href="act_actaemitidasn.php" class="enlace1" title="Actas Emitidas sin Notas">ACTAS  EMITIDAS SIN NOTAS </a></td>
            </tr>
            <tr <? if($vCont % 2 == 0) echo "class=\"celpar\" id=\"p\""; else echo "class=\"celinpar\"  id=\"i\""; $vCont++;?>  onmouseover="mouseover(this)" onmouseout="mouseout(this)">
              <td class="wordcenb"><a href="act_actanoemitida.php" class="enlace1" title="Actas NO Emitidas">ACTAS NO EMITIDAS</a></td>
            </tr>
          </table>
