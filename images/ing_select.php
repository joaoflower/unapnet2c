	  ...
	  <form action="" method="post" enctype="multipart/form-data" name="fData" id="fData">	  
	    <table border="0" cellpadding="0" cellspacing="0" id="ventana">
          <tr>
            ...
            <th align="center" background="../images/ventana_r1_c2.jpg" >Ingreso de Notas en Actas </th>
          ...
          <tr>
            ...
            <td background="../images/ventana_r2_c2.jpg" class="wordcen"><table border="0" cellpadding="1" cellspacing="0" class="tabled">
                <tr>
                  ...
                  <th width="80" class="wordizq">Modalidad</th>
                  <th width="16" class="wordizq">&nbsp;</th>
                </tr>
                <tr>
                  <th class="wordizq">&nbsp;</th>
                  <th class="wordizq"><input name="rPln_est" type="text" class="texto" id="rPln_est" size="1" maxlength="2"  onBlur="searchingcurso();" ></th>
                  <th class="wordizq"><input name="rCod_cur" type="text" class="texto" id="rCod_cur" size="1" maxlength="3"  onBlur="searchingcurso();" ></th>
                  <th class="wordizq"><input name="rNom_cur" type="text" class="texto" id="rNom_cur" onBlur="searchingcurso();" size="45" maxlength="40" ></th>
                  <th class="wordizq"><input name="rNiv_est" type="text" class="texto" id="rNiv_est" size="1" maxlength="2" onBlur="searchingcurso();" ></th>
                  <th class="wordizq"><input name="rSem_anu" type="text" class="texto" id="rSem_anu" size="1" maxlength="2" onBlur="searchingcurso();" ></th>
                  <th class="wordizq">&nbsp;</th>
                  <th class="wordder">Acta:</th>
                  <th class="wordizq"><input name="rCod_act" type="text" class="texto" id="rCod_act" size="4" maxlength="6" onBlur="searchingacta();" ></th>
                  <th class="wordizq">&nbsp;</th>
                </tr>
                <tr>
                  <td colspan="10" class="wordder"></td>
                </tr>
            </table>
