	...
	if(fsafetyselcar2())
	{
		class PDF extends FPDF
		{
			function Header()
			{
				...
				$this->Ln(5);
				$this->SetFont('arialn','B',12);
				$this->Cell(0,5,'RESUMEN DE MATRICULADOS POR NIVELES', 0, 0, 'C');
				$this->Ln();
			...
			function Subhnota()
			{
				...
				$this->Cell(5);
				$this->Cell(130,4,"SISTEMA CURRICULAR: RIGIDO", 0);
				$this->Ln();
...
//				$this->Line(15, 57, 195, 57);	
				...
				$this->Cell(7,5,'SN', 1, 0, 'C');
				$this->Cell(7,5,'N-01', 1, 0, 'C');				
				$this->Cell(7,5,'N-02', 1, 0, 'C');
				$this->Cell(7,5,'N-03', 1, 0, 'C');
				$this->Cell(7,5,'N-04', 1, 0, 'C');
				$this->Cell(7,5,'N-05', 1, 0, 'C');
				$this->Cell(7,5,'N-06', 1, 0, 'C');
				$this->Cell(7,5,'N-07', 1, 0, 'C');
			...
			{			
				...
				{				
					...
					{				
						...
						$this->Cell(7,5,$sPDF[$vCod_car.'1']['ss'], 1, 0, 'C');
						$this->Cell(7,5,$sPDF[$vCod_car.'1']['01'], 1, 0, 'C');					
						$this->Cell(7,5,$sPDF[$vCod_car.'1']['02'], 1, 0, 'C');
						$this->Cell(7,5,$sPDF[$vCod_car.'1']['03'], 1, 0, 'C');
						$this->Cell(7,5,$sPDF[$vCod_car.'1']['04'], 1, 0, 'C');
						$this->Cell(7,5,$sPDF[$vCod_car.'1']['05'], 1, 0, 'C');
						$this->Cell(7,5,$sPDF[$vCod_car.'1']['06'], 1, 0, 'C');
						$this->Cell(7,5,$sPDF[$vCod_car.'1']['07'], 1, 0, 'C');
						$this->Cell(10,5,$sPDF[$vCod_car.'1']['total'], 1, 0, 'C');
						$this->Ln();
					}
				}	
				...
				$this->Cell(7,5,$sEstupdf['ss1'], 1, 0, 'C');
				$this->Cell(7,5,$sEstupdf['011'], 1, 0, 'C');				
				$this->Cell(7,5,$sEstupdf['021'], 1, 0, 'C');
				$this->Cell(7,5,$sEstupdf['031'], 1, 0, 'C');
				$this->Cell(7,5,$sEstupdf['041'], 1, 0, 'C');
				$this->Cell(7,5,$sEstupdf['051'], 1, 0, 'C');
				$this->Cell(7,5,$sEstupdf['061'], 1, 0, 'C');
				$this->Cell(7,5,$sEstupdf['071'], 1, 0, 'C');
				$this->Cell(10,5,$sEstupdf['total1'], 1, 0, 'C');
				$this->Ln();
