        ...
        <tr>
		 ...
		 <table border="1" cellpadding="1" cellspacing="0" bordercolor="#BDD37B" rules="cols, rows" class="tabled">
            ...
            <tr <? if($vCont % 2 == 0) echo "class=\"celpar\""; else echo "class=\"celinpar\"";?>>
              <td class="wordcen">&nbsp;</td>
              <td class="wordizq">&nbsp;</td>
              <td class="wordder"><?=$sCanestu['ss']?>
                &nbsp;</td>
              <td class="wordder"><?=$sCanestu['01']?>
                &nbsp;</td>
              <td class="wordder"><?=$sCanestu['02']?>
                &nbsp;</td>
              <td class="wordder"><?=$sCanestu['03']?>
                &nbsp;</td>
              <td class="wordder"><?=$sCanestu['04']?>
                &nbsp;</td>
              <td class="wordder"><?=$sCanestu['05']?>
                &nbsp;</td>
              <td class="wordder"><?=$sCanestu['06']?>
                &nbsp;</td>
              <td class="wordder"><?=$sCanestu['07']?>
                &nbsp;</td>
              <td class="wordder"><?=$sCanestu['ss']+$sCanestu['01']+$sCanestu['02']+$sCanestu['03']+$sCanestu['04']+$sCanestu['05']+$sCanestu['06']+$sCanestu['07']+$sCanestu['08']+$sCanestu['09']+$sCanestu['10']+$sCanestu['11']+$sCanestu['12']?>
                &nbsp;</td>
            </tr>
			<?	$vCont++;	}	}	?>	
            <tr <? if($vCont % 2 == 0) echo "class=\"celpar\""; else echo "class=\"celinpar\"";?>>
