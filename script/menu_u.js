...
// Administración
	Menu_Item[0] = new Array ("Activar carrera y/o periodo", "../selectcar.php", "");
...
// Maestros
	...
	Menu_Item[9] = new Array ("Actas", 	"../maestros/act_selectrep.php", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
// Matrículas
	Menu_Item[10] = new Array ("Matr&iacute;cula de Ingresantes", 	"../matriculas/ing_getestu.php", "&nbsp;");
	Menu_Item[11] = new Array ("Matr&iacute;cula de regulares", 	"../matriculas/reg_getestu.php", "&nbsp;&nbsp;&nbsp;");
	Menu_Item[12] = new Array ("Edici&oacute;n de Matr&iacute;cula","../matriculas/edt_getestu.php", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
	Menu_Item[13] = new Array ("Cursos Habiles","../matriculas/hac_viewcurso.php", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
// Datos Académicos	
	Menu_Item[14] = new Array ("Historial de notas", 			"../datos_acad/not_getestu.php", "&nbsp;&nbsp;&nbsp;&nbsp;");
	Menu_Item[15] = new Array ("Covalidaci&oacute;n de notas", 	"../datos_acad/con_getestu.php", "&nbsp;&nbsp;&nbsp;");
	Menu_Item[16] = new Array ("Ingreso de notas", 				"../datos_acad/ing_select.php", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
	Menu_Item[17] = new Array ("Reevaluaci&oacute;n y Aplaz.",    		"../datos_acad/rva_selectsem.php", "&nbsp;&nbsp;&nbsp;&nbsp;");
	Menu_Item[18] = new Array ("Cuadro de m&eacute;ritos", 		"../datos_acad/crd_selecsem.php", "&nbsp;&nbsp;&nbsp;&nbsp;");
	Menu_Item[19] = new Array ("Cdo. de m&eacute;ritos(ESP)",	"../datos_acad/crd_selecesp.php", "&nbsp;&nbsp;");
	Menu_Item[20] = new Array ("Asignaci&oacute;n de carga",    "../datos_acad/cga_selectsem.php", "&nbsp;&nbsp;&nbsp;");
	Menu_Item[21] = new Array ("Carga Internet                  ",    "../datos_acad/cgai_selectsem.php", "&nbsp;&nbsp;&nbsp;");
	Menu_Item[22] = new Array ("Resumen de notas",  			"../datos_acad/ren_getestu.php", "&nbsp;");
	Menu_Item[23] = new Array ("Resoluciones", 					"../datos_acad/res_viewreso.php", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
// Reportes
	Menu_Item[24] = new Array ("Niveles y/o grupos", 		"../reportes/niv_select.php", "&nbsp;");
	Menu_Item[25] = new Array ("Relación por semestre",		"../reportes/sem_selectsem.php", "&nbsp;");
	Menu_Item[26] = new Array ("Relaci&oacute;n por curso", "../reportes/cur_select.php",  "&nbsp;");	
	Menu_Item[27] = new Array ("Relaci&oacute;n Ingresantes", "../reportes/ing_selectano.php",  "&nbsp;");	
	Menu_Item[28] = new Array ("Relaci&oacute;n de Pagos", "../reportes/pag_selectcate.php",  "&nbsp;");	
	Menu_Item[29] = new Array ("Resumen por modalidad", "../reportes/res_modmat.php",  "&nbsp;");	
	Menu_Item[30] = new Array ("Res. de curso X grupo", "../reportes/res_curso.php",  "&nbsp;");	
	Menu_Item[31] = new Array ("Res. de curso X mod.", "../reportes/res_cursomm.php",  "&nbsp;");	
	Menu_Item[32] = new Array ("Res. Matric. X Mod.", "../reportes/res_matri.php",  "&nbsp;");	
	Menu_Item[33] = new Array ("Res. Matric. X Sem.", "../reportes/res_matrinivsem.php",  "&nbsp;");	
// Ayuda
	Menu_Item[34] = new Array ("Acerca del sistema",     "../ayuda/", "&nbsp;");

	var Menu_Item_Pos_Ini =new Array(1,5,10,14, 24, 34, 35);
...
//		Menu_Item[12][2] = "Sistemas";
		for (var j=(Menu_Item_Pos_Ini[i-1]);j<=(Menu_Item_Pos_Ini[i]-1);j++)
	    {
	    	document.writeln("<tr>")
	     	document.writeln("	  <td id=op" + j + " bgcolor='#CDE18A' height='18' valign='middle' ><a class='linkmenu' href='javascript:linker(" + j + ",1)' OnMouseOver='color(op" + j + ",item" + j + ",0)' OnMouseOut='color(op" + j + ",item" + j + ",1)' OnClick='linker(" + j + ",1)'><span id=item" + j + ">" + "&nbsp;" + Menu_Item[j][0] + Menu_Item[j][2] + "</span></a></td>")
	     	document.writeln("</tr>")
	     }
