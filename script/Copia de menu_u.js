...
// Datos Académicos	
	Menu_Item[13] = new Array ("Historial de notas", 			"../datos_acad/not_getestu.php", "&nbsp;&nbsp;&nbsp;&nbsp;");
	Menu_Item[14] = new Array ("Covalidaci&oacute;n de notas", 	"../datos_acad/con_getestu.php", "&nbsp;&nbsp;&nbsp;");
	Menu_Item[15] = new Array ("Ingreso de notas", 				"../datos_acad/ing_select.php", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
	Menu_Item[16] = new Array ("Reevaluaci&oacute;n y Aplaz.",    		"../datos_acad/rva_selectsem.php", "&nbsp;&nbsp;&nbsp;&nbsp;");
	Menu_Item[17] = new Array ("Cuadro de m&eacute;ritos", 		"../datos_acad/crd_selecsem.php", "&nbsp;&nbsp;&nbsp;&nbsp;");
	Menu_Item[18] = new Array ("Cdo. de m&eacute;ritos(ESP)",	"../datos_acad/crd_selecesp.php", "&nbsp;&nbsp;");
	Menu_Item[19] = new Array ("Asignaci&oacute;n de carga",    "../datos_acad/cga_selectsem.php", "&nbsp;&nbsp;&nbsp;");
	Menu_Item[20] = new Array ("Carga Internet                  ",    "../datos_acad/cgai_selectsem.php", "&nbsp;&nbsp;&nbsp;");
	Menu_Item[21] = new Array ("Resumen de notas",  			"../datos_acad/ren_getestu.php", "&nbsp;");
	Menu_Item[22] = new Array ("Resoluciones", 					"../datos_acad/res_viewreso.php", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
// Reportes
	Menu_Item[23] = new Array ("Niveles y/o grupos", 		"../reportes/niv_select.php", "&nbsp;");
	Menu_Item[24] = new Array ("Relación por semestre",		"../reportes/sem_selectsem.php", "&nbsp;");
	Menu_Item[25] = new Array ("Relaci&oacute;n por curso", "../reportes/cur_select.php",  "&nbsp;");	
	Menu_Item[26] = new Array ("Relaci&oacute;n Ingresantes", "../reportes/ing_selectano.php",  "&nbsp;");	
	Menu_Item[27] = new Array ("Relaci&oacute;n de Pagos", "../reportes/pag_selectcate.php",  "&nbsp;");	
	Menu_Item[28] = new Array ("Resumen por modalidad", "../reportes/res_modmat.php",  "&nbsp;");	
	Menu_Item[29] = new Array ("Res. de curso X grupo", "../reportes/res_curso.php",  "&nbsp;");	
	Menu_Item[30] = new Array ("Res. de curso X mod.", "../reportes/res_cursomm.php",  "&nbsp;");	
	Menu_Item[31] = new Array ("Res. Matric. X Mod.", "../reportes/res_matri.php",  "&nbsp;");	
	Menu_Item[32] = new Array ("Res. Matric. X Sem.", "../reportes/res_matrinivsem.php",  "&nbsp;");	
// Ayuda
	Menu_Item[33] = new Array ("Acerca del sistema",     "../ayuda/", "&nbsp;");

	var Menu_Item_Pos_Ini =new Array(1,5,10,13, 23, 33, 34);
