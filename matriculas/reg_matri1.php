		...
		if($sUsercoo['safetymatri'])
		{
			...
			while($aNota = $cNota->fetch_array())
			{
				if($aNota['mod_not'] == '01' or $aNota['mod_not'] == '10' or $aNota['mod_not'] == '11'
					...
					or $aNota['mod_not'] == '16' or $aNota['mod_not'] == '17' or $aNota['mod_not'] == '18' or $aNota['mod_not'] == '19' 
					or $aNota['mod_not'] == '20' or $aNota['mod_not'] == '21' or $aNota['mod_not'] == '22'
					or $aNota['mod_not'] == '23' or $aNota['mod_not'] == '24' or $aNota['mod_not'] == '25'
					or $aNota['mod_not'] == '26' or $aNota['mod_not'] == '27' or $aNota['mod_not'] == '28'
					or $aNota['mod_not'] == '29' or $aNota['mod_not'] == '30' or $aNota['mod_not'] == '31' )
				{
					if($aNota['not_cur'] >= 11)
...
//			$vQuery = "Select no.cod_cur, cu.crd_cur, no.not_cur, no.mod_not ";
			...
			if($sUsercoo['cod_car'] == '27' and ($sUsercoo['per_aca'] == '01' or $sUsercoo['per_aca'] == '02'))
			{
			...
			else
			{
				...
				$vQuery .= "(no.mod_not != '13' and no.mod_not != '08') and ";
				$vQuery .= "(cu.tip_cur='01' or cu.tip_cur='03') and (cu.cod_esp='00' or cu.cod_esp='{$sEstudia['cod_esp']}') ";
				$vQuery .= " and no.cod_car = '{$sUsercoo['cod_car']}' and cu.con_cur = '1' and ";
				$vQuery .= "no.cod_cur not in (Select cod_cur from $tNota where pln_est = '{$sEstudia['pln_est']}' and ";
				$vQuery .= "num_mat = '{$sEstudia['num_mat']}' and not_cur > 10) group by cod_cur order by veces desc";
			}
...
<body>
	...
	<div class="wordcen" id="body1">
          ...
          <td background="../images/ventana_r2_c2.jpg" class="wordcen"><table width="220" border="0" cellpadding="1" cellspacing="0" class="tabled">
              ...
              <tr>
                ...
                <td class="wordizqb"><select name="rMod_mat" id="rMod_mat">
				  ...
				  <option value="06">IRREGULAR</option>
				  <?
				  	}
				  ?>
                </select>                  </td>
	  ...
	  <?
	  	//$sEstudia['pln_est']		$sUsercoo['cod_car']	$sUsercoo['ano_aca']	$sUsercoo['per_aca']	$sEstudia['sem_anu']
		$vPln_estok = $sEstudia['pln_est'];
		$vQuery = "select pln_est from unapnet.habiplansem ";
		$vQuery .= "where ano_aca = '{$sUsercoo['ano_aca']}' and per_aca = '{$sUsercoo['per_aca']}' and cod_car = '{$sUsercoo['cod_car']}' and ";
		$vQuery .= "sem_anu = '{$sEstudia['sem_anu']}' ";
		...
		if($vPln_estok != $sEstudia['pln_est'])
		{
	?>
		<table border="0" cellpadding="0" cellspacing="0" id="ventana">
          <tr>
            <th><img name="ventana_r1_c1" src="../images/ventana_r1_c1.jpg" width="12" height="29" border="0" alt=""></th>
            <th align="center" background="../images/ventana_r1_c2.jpg" >ERROR - CAMBIO DE PLAN </th>
            <th><img name="ventana_r1_c4" src="../images/ventana_r1_c4.jpg" width="11" height="29" border="0" alt=""></th>
          </tr>
          <tr>
            <td background="../images/ventana_r2_c1.jpg"></td>
            <td background="../images/ventana_r2_c2.jpg" class="wordi" align="center">EL ESTUDIANTE EST&Aacute; AFECTADO POR UN <strong>NUEVO 
              PLAN</strong> DE ESTUDIOS. <br> 
			  EL PLAN <strong> <?=$vPln_estok?>-FLEXIBLE</strong> YA ESTA EN EL   <strong><?=$sSemestre[$sEstudia['sem_anu']]?></strong>  SEMESTRE, <br>
              <strong>CANCELE LA MATR&Iacute;CULA</strong> Y CAMBIE DE PLAN DE ESTUDIOS. <br>
