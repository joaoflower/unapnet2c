	    ...
	    <table border="0" cellpadding="0" cellspacing="0" id="ventana">
          ...
          <tr>
            ...
            <td background="../images/ventana_r2_c2.jpg" class="wordcen"><table border="0" cellpadding="1" cellspacing="0" class="tabled">
                ...
                <tr>
                  <th class="wordizq	">&nbsp;</th>
                  <th class="wordizq	"><input name="rNum_mat" type="text" class="texto" id="rNum_mat" size="6" maxlength="6"  onBlur="searchedtmest();" >
                  </span></th>
                  <th class="wordizq"><input name="rPaterno" type="text" class="texto" id="rPaterno" onBlur="searchedtmest();" size="20" maxlength="20" ></th>
                  <th class="wordizq"><input name="rMaterno" type="text" class="texto" id="rMaterno" size="20" maxlength="20" onBlur="searchedtmest();" ></th>
                  <th class="wordizq"><input name="rNombres" type="text" class="texto" id="rNombres" size="25" maxlength="30" onBlur="searchedtmest();" ></th>
                  <th class="wordizq">&nbsp;</th>
                </tr>
                <tr>
