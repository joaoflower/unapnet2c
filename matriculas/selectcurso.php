...
<div class="wordcen" id="body1">
	  <form action="savematri.php" method="post" enctype="multipart/form-data" name="fData" id="fData"> 
		...
		<table border="0" cellpadding="0" cellspacing="0" id="ventana">
          ...
          <tr>
            <td background="../images/ventana_r2_c1.jpg"></td>
            <td background="../images/ventana_r2_c2.jpg" class="wordcen"><textarea name="rObs_est" cols="115" rows="2" id="rObs_est" onBlur="fupper(this)">AHORRE TIEMPO Y DINERO, CONSULTE SUS NOTAS, HORARIOS Y REALIZAR SU MATRÍCULA VÍA INTERNET, http://www.unap.edu.pe</textarea></td>
            <td background="../images/ventana_r2_c4.jpg"></td>
          </tr>
          <tr>
            <td><img name="ventana_r4_c1" src="../images/ventana_r4_c1.jpg" width="12" height="10" border="0" alt=""></td>
