	  ...
	  <form action="ing_search.php" method="post" enctype="multipart/form-data" name="fData" id="fData"> 
	    <table border="0" cellpadding="0" cellspacing="0" id="ventana">
          <tr>
            ...
            <th align="center" background="../images/ventana_r1_c2.jpg" >Matr&iacute;cula Realizada </th>
          ...
          <tr>
            ...
            <td background="../images/ventana_r2_c2.jpg"><table border="0" cellpadding="1" cellspacing="0" bordercolor="#BDD37B" rules="cols, rows" class="tabled">
                <tr>
                  <td class="wordi">El estudiante ya realizo su matr&iacute;cula en este periodo </td>
                </tr>
                <tr>
